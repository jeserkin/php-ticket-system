...
?>
				...
				<?php $result = $page->paginate(@$_REQUEST['page']); ?>
				<?php if($page->pageExists()) { ?>
					<ul class="list">
						<li class="key">
